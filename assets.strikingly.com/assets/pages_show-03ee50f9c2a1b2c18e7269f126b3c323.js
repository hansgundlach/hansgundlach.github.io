...
!function(e, t) {
    ...
    var v, y = RegExp.prototype.exec, b = function(e) {
        try {
            return y.call(e), !0;
        } catch (t) {
            return !1;
    ...
    v = function(e) {
        return "object" != typeof e ? !1 : p ? b(e) : h.call(e) === k;
    };
    ...
    M = function(e) {
        return "string" == typeof e ? !0 : "object" != typeof e ? !1 : p ? x(e) : h.call(e) === L;
    };
    var S = function(e) {
    ...
    D(i, {
        bind: function(e) {
            ...
            }, s = Math.max(0, n.length - i.length), l = [], u = 0; s > u; u++) l.push("$" + u);
    ...
    var H = Object("a"), B = "a" !== H[0] || !(0 in H), A = function(e) {
        var t = !0, n = !0;
    ...
    D(n, {
        ...
        map: function(e) {
            ...
            for (var a = 0; i > a; a++) a in o && (r[a] = e.call(s, o[a], a, n));
            return r;
        }
    }, !A(n.map)), D(n, {
        filter: function(e) {
            ...
            if (!t(e)) throw new TypeError(e + " is not a function");
            for (var l = 0; r > l; l++) l in i && (n = i[l], e.call(a, n, l, o) && s.push(n));
            return s;
        }
    }, !A(n.filter)), D(n, {
        every: function(e) {
            ...
            if (!t(e)) throw new TypeError(e + " is not a function");
            for (var s = 0; i > s; s++) if (s in o && !e.call(r, o[s], s, n)) return !1;
            return !0;
        }
    }, !A(n.every)), D(n, {
        some: function(e) {
            var n = Y.ToObject(this), o = B && M(this) ? this.split("") : n, i = o.length >>> 0, r = arguments[1];
            if (!t(e)) throw new TypeError(e + " is not a function");
            for (var s = 0; i > s; s++) if (s in o && e.call(r, o[s], s, n)) return !0;
            return !1;
        }
    }, !A(n.some));
    var j = !1;
    n.reduce && (j = "object" == typeof n.reduce.call("es5", function(e, t, n, o) {
        return o;
    })), D(n, {
        reduce: function(e) {
            ...
            for (;i > s; s++) s in o && (r = e.call(void 0, r, o[s], s, n));
            return r;
        }
    }, !j);
    var N = !1;
    ...
    D(n, {
        indexOf: function(e) {
            ...
            if (!n) return -1;
            var o = 0;
            for (arguments.length > 1 && (o = Y.ToInteger(arguments[1])), o = o >= 0 ? o : Math.max(0, n + o); n > o; o++) if (o in t && t[o] === e) return o;
            return -1;
        }
    }, P);
    var z = Array.prototype.lastIndexOf && -1 !== [ 0, 1 ].lastIndexOf(0, -3);
    D(n, {
    ...
    D(Object, {
        keys: function(e) {
            ...
            if (F) for (var c = e.constructor, d = c && c.prototype === e, h = 0; U > h; h++) {
                var g = V[h];
    ...
    var X = !1;
    try {
        X = Date.prototype.toJSON && null === new Date(NaN).toJSON() && -1 !== new Date(J).toJSON().indexOf(K) && Date.prototype.toJSON.call({
            toISOString: function() {
                return !0;
            }
        });
    ...
    (!Date.parse || ne || te || !ee) && (Date = function(e) {
        ...
        t.parse = function a(t) {
            var r = i.exec(t);
            if (r) {
                var s, l = Number(r[1]), a = Number(r[2] || 1) - 1, u = Number(r[3] || 1) - 1, c = Number(r[4] || 0), d = Number(r[5] || 0), h = Number(r[6] || 0), g = Math.floor(1e3 * Number(r[7] || 0)), p = Boolean(r[4] && !r[8]), m = "-" === r[9] ? 1 : -1, f = Number(r[10] || 0), _ = Number(r[11] || 0);
                return (d > 0 || h > 0 || g > 0 ? 24 : 25) > c && 60 > d && 60 > h && 1e3 > g && a > -1 && 12 > a && 24 > f && 60 > _ && u > -1 && u < n(l, a + 1) - n(l, a) && (s = 60 * (24 * (n(l, a) + u) + c + f * m), 
                s = 1e3 * (60 * (s + d + _ * m) + h) + g, p && (s = o(s)), s >= -864e13 && 864e13 >= s) ? s : NaN;
            }
    ...
    var oe = s.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== 0xde0b6b3a7640080.toFixed(0)), ie = {
        base: 1e7,
        size: 6,
        data: [ 0, 0, 0, 0, 0, 0 ],
        multiply: function(e, t) {
            for (var n = -1; ++n < ie.size; ) t += e * ie.data[n], ie.data[n] = t % ie.base, 
            t = Math.floor(t / ie.base);
        },
        divide: function(e) {
            for (var t = ie.size, n = 0; --t >= 0; ) n += ie.data[t], ie.data[t] = Math.floor(n / e), 
            n = n % e * ie.base;
        },
    ...
    D(s, {
        toFixed: function(e) {
            ...
            if (o = "", 0 > n && (o = "-", n = -n), i = "0", n > 1e-21) if (r = ie.log(n * ie.pow(2, 69, 1)) - 69, 
            s = 0 > r ? n * ie.pow(2, -r, 1) : n / ie.pow(2, r, 1), s *= 4503599627370496, r = 52 - r, 
            r > 0) {
                for (ie.multiply(0, s), a = t; a >= 7; ) ie.multiply(1e7, 0), a -= 7;
                for (ie.multiply(ie.pow(10, a, 1), 0), a = r - 1; a >= 23; ) ie.divide(1 << 23), 
                a -= 23;
                ie.divide(1 << a), ie.multiply(1, 1), ie.divide(2), i = ie.numToString();
            } else ie.multiply(0, s), ie.multiply(1 << -r, 0), i = ie.numToString() + "0.00000000000000000000".slice(2, 2 + t);
    ...
    2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || ".".split(/()()/).length > 1 ? !function() {
        ...
        r.split = function(t, n) {
            ...
            if (!v(t)) return re.call(this, t, n);
        ...
        return "undefined" == typeof e && 0 === t ? [] : re.call(this, e, t);
    });
    var se = r.replace, ae = function() {
        var e = [];
        return "x".replace(/x(.)?/g, function(t, n) {
            e.push(n);
        }), 1 === e.length && "undefined" == typeof e[0];
    }();
    ae || (r.replace = function(e, n) {
        var o = t(n), i = v(e) && /\)[*?]/.test(e.source);
        if (o && i) {
            var r = function(t) {
    ...
    var le = r.substr, ue = "".substr && "b" !== "0b".substr(-1);
    D(r, {
        substr: function(e, t) {
            return le.call(this, 0 > e && (e = this.length + e) < 0 ? 0 : e, t);
        }
    }, ue);
    var ce = " \n\x0B\f\r   ᠎             　\u2028\u2029\ufeff", de = "​", he = "[" + ce + "]", ge = new RegExp("^" + he + he + "*"), pe = new RegExp(he + he + "*$"), me = r.trim && (ce.trim() || !de.trim());
    D(r, {
        trim: function() {
            if ("undefined" == typeof this || null === this) throw new TypeError("can't convert " + this + " to object");
            return String(this).replace(ge, "").replace(pe, "");
        }
    ...
    var i = /\+/g, r = e.cookie = function(i, s, a) {
        ...
        for (var c = r.raw ? t : n, d = document.cookie.split("; "), h = i ? void 0 : {}, g = 0, p = d.length; p > g; g++) {
    ...
    easeInOutElastic: function(e, t, n, o, i) {
        ...
        return 1 > t ? -.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * i - r) * (2 * Math.PI) / s)) + n : a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * i - r) * (2 * Math.PI) / s) * .5 + o + n;
    },
    ...
    easeOutBounce: function(e, t, n, o, i) {
        return (t /= i) < 1 / 2.75 ? o * (7.5625 * t * t) + n : 2 / 2.75 > t ? o * (7.5625 * (t -= 1.5 / 2.75) * t + .75) + n : 2.5 / 2.75 > t ? o * (7.5625 * (t -= 2.25 / 2.75) * t + .9375) + n : o * (7.5625 * (t -= 2.625 / 2.75) * t + .984375) + n;
    },
        ...
        f = 1, _ = "waypoints-waypoint-ids", w = "waypoint", v = "waypoints", r = function() {
            function e(e) {
                ...
                this.id = "context" + l++, this.oldScroll = {
                    ...
                    }, o.setTimeout(e, n[v].settings.scrollThrottle));
                }), e.bind(p, function() {
                    var e;
                    return t.didResize ? void 0 : (t.didResize = !0, e = function() {
                        return n[v]("refresh"), t.didResize = !1;
                    }, o.setTimeout(e, n[v].settings.resizeThrottle));
                });
            }
            return e.prototype.doScroll = function() {
                ...
                }, !d || e.vertical.oldScroll && e.vertical.newScroll || n[v]("refresh"), n.each(e, function(e, o) {
                    var i, r, s;
                ...
                e = {
                    ...
                    vertical: {
                        ...
                        contextDimension: o ? n[v]("viewportHeight") : this.$element.height(),
                        oldScroll: this.oldScroll.y,
                        forward: "down",
                        backward: "up",
                        offsetProp: "top"
                    ...
                    return n.each(i.waypoints[e], function(e, o) {
                        var i, r, s, a, l;
                        return i = o.options.offset, s = o.offset, r = n.isWindow(o.element) ? 0 : o.$element.offset()[t.offsetProp], 
                        ...
                        o.offset = r - t.contextOffset + t.contextScroll - i, o.options.onlyOnScroll && null != s || !o.enabled ? void 0 : null !== s && s < (a = t.oldScroll) && a <= o.offset ? o.trigger([ t.backward ]) : null !== s && s > (l = t.oldScroll) && l >= o.offset ? o.trigger([ t.forward ]) : null === s && t.oldScroll >= o.offset ? o.trigger([ t.forward ]) : void 0;
                    });
                });
            }, e.prototype.checkEmpty = function() {
                return n.isEmptyObject(this.waypoints.horizontal) && n.isEmptyObject(this.waypoints.vertical) ? (this.$element.unbind([ p, m ].join(" ")), 
    ...
    e.fn.ajaxSubmit = function(n) {
        function o(o) {
            ...
            function s() {
                function n() {
                    try {
                        ...
                        t("Server abort: ", o, " (", o.name, ")"), l(T), y && clearTimeout(y), y = void 0;
                    }
                }
            ...
            function l(n) {
                if (!f.aborted && !S) {
                    try {
                        ...
                        t("cannot access response document: ", o), n = T;
                    }
                    if (n === M && f) return void f.abort("timeout");
                    if (n == T && f) return void f.abort("server abort");
                    if (L && L.location.href != d.iframeSrc || v) {
                        m.detachEvent ? m.detachEvent("onload", l) : m.removeEventListener("load", l, !1);
                        var i, s = "success";
                        try {
                            if (v) throw "timeout";
                            var a = "xml" == d.dataType || L.XMLDocument || e.isXMLDoc(L);
                            if (t("isXml=" + a), !a && window.opera && (null == L.body || "" == L.body.innerHTML) && --D) return t("requeing onLoad callback, DOM not available"), 
                            ...
                            a && (d.dataType = "xml"), f.getResponseHeader = function(e) {
                                var t = {
                            ...
                            var c = d.dataType || "", g = /(json|script|text)/.test(c.toLowerCase());
                            if (g || d.textarea) {
                                var _ = L.getElementsByTagName("textarea")[0];
                                if (_) f.responseText = _.value, f.status = Number(_.getAttribute("status")) || f.status, 
                                f.statusText = _.getAttribute("statusText") || f.statusText; else if (g) {
                                    var w = L.getElementsByTagName("pre")[0], b = L.getElementsByTagName("body")[0];
                                    w ? f.responseText = w.textContent ? w.textContent : w.innerHTML : b && (f.responseText = b.innerHTML);
                                }
                            } else "xml" != d.dataType || f.responseXML || null == f.responseText || (f.responseXML = Y(f.responseText));
                            try {
                                x = E(f, d.dataType, d);
                            } catch (n) {
                                s = "parsererror", f.error = i = n || s;
                            }
                        } catch (n) {
                            t("error caught: ", n), s = "error", f.error = i = n || s;
                        }
                        f.aborted && (t("upload aborted"), s = null), f.status && (s = f.status >= 200 && f.status < 300 || 304 === f.status ? "success" : "error"), 
                        "success" === s ? (d.success && d.success.call(d.context, x, "success", f), h && e.event.trigger("ajaxSuccess", [ f, d ])) : s && (void 0 == i && (i = f.statusText), 
                        d.error && d.error.call(d.context, f, s, i), h && e.event.trigger("ajaxError", [ f, d, i ])), 
                        h && e.event.trigger("ajaxComplete", [ f, d ]), h && !--e.active && e.event.trigger("ajaxStop"), 
                        d.complete && d.complete.call(d.context, f, s), S = !0, d.timeout && clearTimeout(y), 
                        setTimeout(function() {
            ...
            var u, c, d, h, g, p, m, f, _, w, v, y, b = a[0], k = !!e.fn.prop;
        ...
        n.success = function(e, t, o) {
            for (var i = n.context || n, r = 0, s = p.length; s > r; r++) p[r].apply(i, [ e, t, o || a, a ]);
        };
        ...
        if (!i) return n;
        var r, s, a, l, u, c, d;
        for (r = 0, c = i.length; c > r; r++) if (u = i[r], a = u.name) if (t && o.clk && "image" == u.type) u.disabled || o.clk != u || (n.push({
            name: a,
            value: e(u).val()
        }), n.push({
            name: a + ".x",
        ...
        return this.each(function() {
            ...
            if (o) {
                ...
                if (i && i.constructor == Array) for (var r = 0, s = i.length; s > r; r++) n.push({
                    name: o,
                    value: i[r]
        ...
        if ("select" == r) {
            ...
            if (0 > s) return null;
            for (var a = [], l = t.options, u = "select-one" == i, c = u ? s + 1 : l.length, d = u ? s : 0; c > d; d++) {
                var h = l[d];
                if (h.selected) {
                    var g = h.value;
    ...
    e.waitForImages = {
        ...
        return this.each(function() {
            var a = e(this), l = [], u = e.waitForImages.hasImageProperties || [], c = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
            ...
            }), r = l.length, s = 0, 0 === r && n.call(a[0]), e.each(l, function(i, l) {
                var u = new Image();
                e(u).on("load." + t + " error." + t, function(e) {
                    return s++, o.call(l.element, s, r, "load" == e.type), s == r ? (n.call(a[0]), !1) : void 0;
                }), u.src = l.src;
            });
        });
    };
    ...
    function r(e) {
        return l(String(e).split(/&|;/), function(e, t) {
            ...
            var o = t.indexOf("="), r = a(t), s = t.substr(0, r || o), l = t.substr(r || o, t.length);
            return l = l.substr(l.indexOf("=") + 1, l.length), "" === s && (s = t, l = ""), 
            i(e, s, l);
        }, {
            base: {}
        }).base;
    ...
    function n(t, n) {
        ...
        !!s && o(s)) : !1) : (/input|select|textarea|button|object/.test(a) ? !t.disabled : "a" === a ? t.href || n : n) && o(t);
    }
    function o(t) {
    ...
    e.cleanData = function(t) {
        ...
        for (var i, r, s = o.call(arguments, 1), a = 0, l = s.length; l > a; a++) for (i in s[a]) r = s[a][i], 
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _create: function() {
            ...
            this.floating = this.items.length ? "x" === e.axis || o(this.items[0].item) : !1, 
        ...
        _intersectsWith: function(e) {
            var t = this.positionAbs.left, n = t + this.helperProportions.width, o = this.positionAbs.top, i = o + this.helperProportions.height, r = e.left, s = r + e.width, a = e.top, l = a + e.height, u = this.offset.click.top, c = this.offset.click.left, d = "x" === this.options.axis || o + u > a && l > o + u, h = "y" === this.options.axis || t + c > r && s > t + c, g = d && h;
        ...
        _refreshItems: function(t) {
            ...
            for (n = d.length - 1; n >= 0; n--) for (s = d[n][1], a = d[n][0], o = 0, u = a.length; u > o; o++) l = e(a[o]), 
    ...
    function h(e, t, n, o) {
        ...
        o = null == o ? !0 : o, i && e._d.setTime(+e._d + i * n), r && oe(e, "Date", ne(e, "Date") + r * n), 
    ...
    function m(e, t, n) {
        ...
        for (o = 0; i > o; o++) (n && e[o] !== t[o] || !n && v(e[o]) !== v(t[o])) && s++;
        return s + r;
    }
    function f(e) {
        if (e) {
    ...
    function T(e) {
        var t;
        e._a && -2 === e._pf.overflow && (t = e._a[me] < 0 || e._a[me] > 11 ? me : e._a[fe] < 1 || e._a[fe] > y(e._a[pe], e._a[me]) ? fe : e._a[_e] < 0 || e._a[_e] > 23 ? _e : e._a[we] < 0 || e._a[we] > 59 ? we : e._a[ve] < 0 || e._a[ve] > 59 ? ve : e._a[ye] < 0 || e._a[ye] > 999 ? ye : -1, 
    ...
    function B(e) {
        e = e || "";
        var t = e.match(He) || [], n = t[t.length - 1] || [], o = (n + "").match(Je) || [ "-", 0, 0 ], i = +(60 * o[1]) + v(o[2]);
        return "+" === o[0] ? -i : i;
    }
    function A(e, t, n) {
        var o, i = n._a;
    ...
    function j(e) {
        ...
        if (!e._d) {
            ...
            d[_e] += v((e._tzm || 0) / 60), d[we] += v((e._tzm || 0) % 60), e._d = (e._useUTC ? G : q).apply(null, d);
        }
    }
    function N(e) {
        var t;
    ...
    function z(e) {
        ...
        e._isPm === !1 && 12 === e._a[_e] && (e._a[_e] = 0), j(e), T(e);
    }
    function F(e) {
    ...
    function U(t) {
        ...
        j(t)) : p(n) ? t._d = new Date(+n) : "object" == typeof n ? N(t) : "number" == typeof n ? t._d = new Date(n) : le.createFromInputFallback(t);
    }
    ...
    for (var le, ue, ce, de = "2.6.0", he = "undefined" != typeof global ? global : this, ge = Math.round, pe = 0, me = 1, fe = 2, _e = 3, we = 4, ve = 5, ye = 6, be = {}, ke = {
        ...
        !function(e) {
            ...
            m.exportSymbol = function(e, t) {
                ...
                return {
                    ...
                    replaceDomNodes: function(e, t) {
                        ...
                        if (n.length > 0) {
                            for (var o = n[0], i = o.parentNode, r = 0, s = t.length; s > r; r++) i.insertBefore(t[r], o);
                            for (var r = 0, s = n.length; s > r; r++) m.removeNode(n[r]);
                        }
                    },
            ...
            m.memoization = function() {
                ...
                function o(e, t) {
                    ...
                    } else if (1 == e.nodeType) for (var i = 0, r = e.childNodes, s = r.length; s > i; i++) o(r[i], t);
                }
                var i = {};
                return {
                    memoize: function(e) {
            ...
            var v = m.observable.protoProperty = "__ko_proto__";
            m.observable.fn[v] = m.observable, m.utils.canSetPrototype && m.utils.setPrototypeOf(m.observable.fn, m.subscribable.fn), 
            m.hasPrototype = function(e, n) {
                return null === e || e === t || e[v] === t ? !1 : e[v] === n ? !0 : m.hasPrototype(e[v], n);
            }, m.isObservable = function(e) {
                return m.hasPrototype(e, m.observable);
            }, m.isWriteableObservable = function(e) {
                return "function" == typeof e && e[v] === m.observable ? !0 : "function" == typeof e && e[v] === m.dependentObservable && e.hasWriteFunction ? !0 : !1;
            ...
            m.extenders.trackArrayChanges = function(e) {
                ...
                if (!e.cacheDiffForKnownOperation) {
                    ...
                    e.subscribe = e.subscribe = function(e, n, o) {
                        return o === y && t(), s.apply(this, arguments);
                        ...
                        if (o && !r) {
                            ...
                            switch (t) {
                              ...
                              case "unshift":
                                for (var d = 0; u > d; d++) s("added", n[d], c + d);
                                break;
                              ...
                              case "splice":
                                for (var h = Math.min(Math.max(0, n[0] < 0 ? l + n[0] : n[0]), l), g = 1 === u ? l : Math.min(h + (n[1] || 0), l), p = h + u - 2, f = Math.max(g, p), _ = [], w = [], d = h, v = 2; f > d; ++d, 
                                ++v) g > d && w.push(s("deleted", e[d], d)), p > d && _.push(s("added", n[v], d));
                ...
                var g, p = !0, f = !1, _ = !1, w = !1, v = n, y = !1, b = !1;
                ...
                m.selectExtensions = {
                    ...
                    writeValue: function(n, o, i) {
                        switch (m.utils.tagNameLower(n)) {
                          ...
                          case "select":
                            ("" === o || null === o) && (o = t);
                            for (var r, s = -1, a = 0, l = n.options.length; l > a; ++a) if (r = m.selectExtensions.readValue(n.options[a]), 
                            r == o || "" == r && o === t) {
                                s = a;
                                break;
                            }
            ...
            function() {
                ...
                function h(e, n, i, r) {
                    ...
                    if (c) {
                        ...
                        var v = d(c);
                        m.utils.arrayForEach(v, function(n) {
                            ...
                            try {
                                ...
                                throw u.message = 'Unable to process binding "' + a + ": " + c[a] + '"\nMessage: ' + u.message, 
                                u;
                            }
                        });
                    }
            ...
            m.bindingHandlers.hasfocus = {
                init: function(e, t, n) {
                    var o = function(o) {
                        ...
                        var a = t();
                        m.expressionRewriting.writeValueToProperty(a, n, "hasfocus", o, !0), e[x] = o, e[T] = !1;
            ...
            m.bindingHandlers.selectedOptions = {
                ...
                m.bindingHandlers.textInput = {
                    init: function(n, o, r) {
                        ...
                        f("dragend", g))) : (f("input", h), 5 > s && "textarea" === m.utils.tagNameLower(n) ? (f("keydown", g), 
                        f("paste", g), f("cut", g)) : 11 > i ? f("keydown", g) : 4 > a && (f("DOMAutoComplete", h), 
            ...
            m.utils.findMovesInArrayComparison = function(e, t, n) {
                ...
                function t(e, t, n, o, i) {
                    ...
                    for (r = 0; p >= r; r++) for (l = a, g.push(a = []), u = d(f, r + _), c = h(0, r - 1), 
                    s = c; u >= s; s++) if (s) if (r) if (e[r - 1] === t[s - 1]) a[s] = l[s - 1]; else {
                        var v = l[s] || w, y = a[s - 1] || w;
                        a[s] = d(v, y) + 1;
                ...
                m.utils.setDomNodeChildrenFromArrayMapping = function(o, i, r, s, a) {
                    function l(e, t) {
                        c = p[t], y !== t && (T[e] = c), c.indexObservable(y++), m.utils.fixUpContinuousNodeArray(c.mappedNodes, o), 
                        w.push(c), k.push(c);
                    }
                    function u(e, t) {
                    ...
                    for (var c, d, h, g = m.utils.domData.get(o, n) === t, p = m.utils.domData.get(o, n) || [], f = m.utils.arrayMap(p, function(e) {
                        return e.arrayEntry;
                    }), _ = m.utils.compareArrays(f, i, s.dontLimitMoves), w = [], v = 0, y = 0, b = [], k = [], M = [], T = [], x = [], L = 0; d = _[L]; L++) switch (h = d.moved, 
                    d.status) {
                      case "deleted":
                        h === t && (c = p[v], c.dependentObservable && c.dependentObservable.dispose(), 
    ...
    var n = "ko_sortItem", o = "ko_sourceIndex", i = "ko_sortList", r = "ko_parentList", s = "ko_dragItem", a = e.utils.unwrapObservable, l = e.utils.domData.get, u = e.utils.domData.set, c = t.ui && t.ui.version, d = c && c.indexOf("1.6.") && c.indexOf("1.7.") && (c.indexOf("1.8.") || "1.8.24" === c), h = function(t, o) {
        ...
        var n = a(t);
        if (n) for (var o = 0; e > o; o++) n[o] && a(n[o]._destroy) && e++;
        return e;
    }, m = function(n, o) {
        var i, r;
    ...
    e.bindingHandlers.sortable = {
        init: function(c, h, f, _, w) {
            var v, y, b = t(c), k = a(h()) || {}, M = g(h, "foreach"), T = {};
            ...
            delete k.options), e.utils.extend(T, k), T.connectClass && (e.isObservable(T.allowDrop) || "function" == typeof T.allowDrop) ? e.computed({
                ...
                return M;
            }, f, _, w), v = T.options.start, y = T.options.update;
            var x = setTimeout(function() {
                ...
                b.sortable(e.utils.extend(T.options, {
                    ...
                    update: function(s, a) {
                        var c, g, m, f, _, w = a.item[0], v = a.item.parent()[0], b = l(w, n) || h;
                        if (h = null, b && this === v || !d && t.contains(this, v)) {
                    ...
                    connectWith: T.connectClass ? "." + T.connectClass : !1
        ...
        init: function(n, o, i, r, l) {
            ...
            return c = "data" in c ? c.data : c, u(n, s, c), e.utils.extend(h, d), h.connectToSortable = m ? "." + m : !1, 
        ...
        if (s = s || "", _) {
            ...
            n.mappedRemove = function(e) {
                ...
                return n.remove(function(t) {
                    return -1 != e.utils.arrayIndexOf(o, E(t));
                });
            ...
            $ && I.sort();
            var O, H, B = e.utils.compareArrays(C, I), A = {}, j = e.utils.unwrapObservable(o), N = {}, P = !0;
            for (O = 0, H = j.length; H > O; O++) {
                var z = E(j[O]);
            ...
            if (L() && (n = S(n)), v.save(o, n), L()) return n;
            g(o, function(t) {
                ...
                if (-1 == e.utils.arrayIndexOf(r.ignore, i)) {
                    ...
                    var s = v.get(o[t]), a = l(n[t], o[t], r, t, n, i, n), u = s || a;
    ...
    var w, v, y = !0, b = "__ko_mapping__", k = e.dependentObservable, M = 0, T = [ "create", "update", "key", "arrayChanged" ], x = {}, L = {
        include: [ "_destroy" ],
        ignore: [],
        copy: [],
        observe: []
    ...
    t.isMapped = function(t) {
        ...
        return g(a, function(n) {
            if (!i.ignore || -1 == e.utils.arrayIndexOf(i.ignore, n)) {
                var r = a[n];
                if (i.parentName = m(l, a, n), -1 !== e.utils.arrayIndexOf(i.copy, n) || -1 !== e.utils.arrayIndexOf(i.include, n) || !a[b] || !a[b].mappedProperties || a[b].mappedProperties[n] || !a[b].copiedProperties || a[b].copiedProperties[n] || "array" === t.getType(a)) {
    ...
    var t = this, n = t._, o = {}, i = Array.prototype, r = Object.prototype, s = Function.prototype, a = i.slice, l = i.unshift, u = r.toString, c = r.hasOwnProperty, d = i.forEach, h = i.map, g = i.reduce, p = i.reduceRight, m = i.filter, f = i.every, _ = i.some, w = i.indexOf, v = i.lastIndexOf, y = Array.isArray, b = Object.keys, k = s.bind, M = function(e) {
        return new $(e);
    };
    ...
    M.map = M.collect = function(e, t, n) {
        ...
        return null == e ? i : f && e.every === f ? e.every(t, n) : (T(e, function(e, r, s) {
            return (i = i && t.call(n, e, r, s)) ? void 0 : o;
        }), i);
    };
    var x = M.some = M.any = function(e, t, n) {
        ...
        return null == e ? i : _ && e.some === _ ? e.some(t, n) : (T(e, function(e, r, s) {
            return i || (i = t.call(n, e, r, s)) ? o : void 0;
        }), !!i);
    };
    M.include = M.contains = function(e, t) {
        var n = !1;
        return null == e ? n : w && e.indexOf === w ? -1 != e.indexOf(t) : n = x(e, function(e) {
            return e === t;
        });
        ...
        for (var e = a.call(arguments), t = M.max(M.pluck(e, "length")), n = new Array(t), o = 0; t > o; o++) n[o] = M.pluck(e, "" + o);
        return n;
    ...
    n.extend(a, {
        ...
        helpers: {},
        open: function(e, t) {
            return e && (n.isPlainObject(t) || (t = {}), !1 !== a.close(!0)) ? (n.isArray(e) || (e = d(e) ? n(e).get() : [ e ]), 
            ...
            }), a.opts = n.extend(!0, {}, a.defaults, t), t.keys !== o && (a.opts.keys = t.keys ? n.extend({}, a.defaults.keys, t.keys) : !1), 
            a.group = e, a._start(a.opts.index)) : void 0;
        },
        cancel: function() {
            var e = a.coming;
        ...
        jumpto: function(e, t, n) {
            ...
            a.router = n || "jumpto", i.loop && (0 > e && (e = i.group.length + e % i.group.length), 
        ...
        bindEvents: function() {
            ...
            e = t.keys, e && s.bind("keydown.fb", function(i) {
                ...
                l = n(l).parent();
                0 === o || u || a.group.length > 1 && !t.canShrink && (r > 0 || i > 0 ? a.prev(r > 0 ? "down" : "left") : (0 > r || 0 > i) && a.next(0 > r ? "up" : "right"), 
                e.preventDefault());
            }));
        },
        ...
        _setDimension: function() {
            var e, t, o, i, r, s, l, u, c, d, h, p, _, w, v, y = a.getViewport(), b = 0, k = !1, M = !1, T = a.wrap, x = a.skin, L = a.inner, S = a.current, D = S.width, Y = S.height, $ = S.minWidth, E = S.minHeight, C = S.maxWidth, I = S.maxHeight, O = S.scrolling, H = S.scrollOutside ? S.scrollbarWidth : 0, B = S.margin, A = m(B[1] + B[3]), j = m(B[0] + B[2]);
            if (T.add(x).add(L).width("auto").height("auto").removeClass("fancybox-tmp"), e = m(x.outerWidth(!0) - x.width()), 
            t = m(x.outerHeight(!0) - x.height()), o = A + e, i = j + t, r = g(D) ? (y.w - o) * m(D) / 100 : D, 
            s = g(Y) ? (y.h - i) * m(Y) / 100 : Y, "iframe" === S.type) {
                if (w = S.content, S.autoHeight && 1 === w.data("ready")) try {
                    w[0].contentWindow.document.location && (L.width(r).height(9999), v = w.contents().find("body"), 
                    H && v.css("overflow-x", "hidden"), s = v.outerHeight(!0));
                } catch (N) {}
            ...
            S.fitToView && (C = Math.min(y.w - o, C), I = Math.min(y.h - i, I)), p = y.w - A, 
            _ = y.h - j, S.aspectRatio ? (D > C && (D = C, Y = m(D / c)), Y > I && (Y = I, D = m(Y * c)), 
            $ > D && (D = $, Y = m(D / c)), E > Y && (Y = E, D = m(Y * c))) : (D = Math.max($, Math.min(D, C)), 
            ...
            H && "auto" === O && s > Y && p > D + e + H && (D += H), L.width(D).height(Y), T.width(D + e), 
            d = T.width(), h = T.height(), k = (d > p || h > _) && D > $ && Y > E, M = S.aspectRatio ? l > D && u > Y && r > D && s > Y : (l > D || u > Y) && (r > D || s > Y), 
            n.extend(S, {
                dim: {
                    width: f(d),
                    height: f(h)
            ...
            }), !w && S.autoHeight && Y > E && I > Y && !M && L.height("auto");
        },
        ...
        open: function(e) {
            ...
            e.closeClick && this.overlay.bind("click.overlay", function(e) {
                return n(e.target).hasClass("fancybox-overlay") ? (a.isActive ? a.close() : t.close(), 
                !1) : void 0;
        ...
        onReady: function(e, t) {
            var o = this.overlay;
            n(".fancybox-overlay").stop(!0, !0), o || this.create(e), e.locked && this.fixed && t.fixed && (o || (this.margin = s.height() > r.height() ? n("html").css("margin-right").replace("px", "") : !1), 
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.stripDiacritics = function(e) {
        ...
        var t;
        return t = "true" === $B.store.get("strikinglyLogger") || $B.log.enabledFlag, $B.log.enabled() && "undefined" != typeof console && null !== console && "function" == typeof console.log ? console.log(Array.prototype.slice.call(arguments)) : void 0;
        ...
        for (s = 0, a = t.length; a > s; s++) if (r = t[s], void 0 !== n.style[r + i]) return !0;
        return !1;
    }, function(e) {
        var t;
        ...
        openModal: function(e, t) {
            ...
            return u = _.extend({}, this.defaultOptions, t), c = _.last(this.modalStk), e.is(":visible") && "1" === e.css("opacity") ? void 0 : (r = e.parent().is(".strikingly-fixed-modal-container") ? e.parent() : ".strikingly-modal-container", 
            ...
            h = function() {
                ...
                var t, n;
                return n = e.width(), t = e.height(), n !== l || t !== s ? (l = n, s = t, a()) : void 0;
            }, u.noResize || (this.modalResizeTimer = setInterval(o, 20)), $(r).click(function(e) {
                return e.target === this ? $B.ui.closeLastModal(!0) : void 0;
            ...
            e.on("strikinglyCloseModal", function() {
                ...
                dialog: e,
                options: u
            }), u.preventScrollBubbling && this.preventScrollBubblingForDialog($(r)), (n = $(".s-modal-bg")).length ? (n.css("opacity", 0).show(), 
        ...
        closeModal: function(e, t) {
            var n, o, i, r, s;
            return i = _.extend({}, this.defaultOptions, t), i.closeCallback && !e.data("hasModalCloseCallback") && (e.data("hasModalCloseCallback", !0), 
            e.on("strikinglyCloseModal", function() {
                ...
                return n.hide();
            }), e.is(":visible") || $(e).parent().is(".strikingly-fixed-modal-container") ? (e.addClass("invisible"), 
            ...
            setTimeout(function(t) {
                return function() {
                    var n;
                    return n = _.last(t.modalStk), e.parent().is(".strikingly-fixed-modal-container") && e.parent().hide(), 
                    e.parent().is(".strikingly-modal-container") && e.unwrap(), clearInterval(t.modalResizeTimer), 
                    n && $(n.dialog.parent()).show(), e.hide(), o ? s.hide() : void 0;
                };
            }(this), 300), e.trigger("strikinglyCloseModal")) : void 0;
        },
        ...
        openIframePopup: function(e, t) {
            ...
            })), null != a.extra && l.css(a.extra), setTimeout(function() {
        ...
        preventScrollBubblingForDialog: function(e) {
            return function(e) {
                ...
                t = function(e) {
                    ...
                    var o, i, r, s, a;
                    for (a = n.target || null, o = $(a), r = o[0], i = !1; o.length && !o.is(e[0]) && !i; ) i = t(o[0]), 
                    r = o[0], o = o.parent();
                    return i ? (s = "DOMMouseScroll" === n.type ? -40 * n.originalEvent.detail : n.originalEvent.wheelDelta, 
                    s > 0 && 0 === r.scrollTop || 0 > s && r.scrollTop >= r.scrollHeight - r.clientHeight ? n.preventDefault() : void 0) : n.preventDefault();
                });
            };
        }(this),
        preventScrollBubblingForElement: function(e) {
            return function(e) {
                ...
                e.bind("mousewheel wheel DOMMouseScroll", function(t) {
                    ...
                    a = r.scrollTop, s = r.scrollHeight, n = e.height(), o > 0) {
                        if (1 > a) return t.preventDefault(), e.scrollTop(0);
                    } else if (i = -o, a + n + i > s) return t.preventDefault(), e.scrollTop(s);
                }));
            };
        }(this)
    }, $B.Queue = function() {
        ...
        checkClosingTags: function(e) {
            ...
            r = r.replace(s, "");
            for (u = null != (h = r.match(t)) ? h : [], n = 0, c = 0, d = u.length; d > c; c++) if (a = u[c], 
            !o(a) && ("/" !== a[1] ? n += 1 : n -= 1, 0 > n)) return !1;
            return 0 === n;
        }
    }, $B.ImageOptionHelper = {
        IMAGE_SIZE: {
        ...
        return e.prototype.fbLoginPopup = function(e) {
            ...
            var t, n;
            return null == e && (e = {}), ("undefined" != typeof $S && null !== $S && null != (t = $S.global_conf) ? t.in_china : void 0) || ("undefined" != typeof $S && null !== $S && null != (n = $S.globalConf) ? n.in_china : void 0) ? void 0 : (window.fbAsyncInit = function(t) {
                return function() {
                    return FB.init({
        ...
        a = [], r = 0, s = o.length; s > r; r++) t = o[r], a.push($.ajax({
            type: "POST",
        ...
        return function(e) {
            ...
            t = {
                matchedType: "",
                rs: !1
            }, null != n && null != (c = n[1]) ? c.length : void 0) for (i = n[1], s = 0, l = r.length; l > s; s++) if (o = r[s], 
            parseInt(i, 10) === o.id) return t.publicURL = o.public_url, t.pageID = "(strikingly-page-id-" + o.id + ")", 
            t.matchedType = "id", t.rs = !0, t;
            for (a = 0, u = r.length; u > a; a++) if (o = r[a], e === o.public_url) return t.publicURL = o.public_url, 
        ...
        var t, n, o, i, r, s, a;
        for (i = e.split("."), n = $S, s = 0, a = i.length; a > s; s++) if (o = i[s], t = o.replace(/[-_\s]+(.)?/g, function(e, t) {
    ...
    e = function() {
        ...
        return t.prototype.lookup_referrer = function(e, t) {
            ...
            for (i in e) {
                ...
                })), c = n.domains, l = 0, u = c.length; u > l; l++) o = c[l], a[o] = {
                    name: s,
                    medium: i
                }, r && (a[o].params = r);
            }
    ...
    $B.UserAnalyticsEngine = function() {
        ...
        return t.prototype.pingInterval = 1e4, t.prototype.setInternalTracking = function() {
            ...
            return $B.log("[GA] Setup internal GA: ", this.strkGaTracker), "function" == typeof __ga && __ga("create", this.strkGaTracker, {
                name: "strk",
                cookieDomain: "auto"
            }), this.isGoogleAnalyticsEnabled() ? ($B.log("[GA] Setup GA for user: ", this.googleAnalyticsTracker), 
            ...
            _gaq.push([ "_setAccount", this.googleAnalyticsTracker ]))) : void 0;
        }, t.prototype.trackPageViewOnGA = function() {
            return $B.log("[GA] Send page view to internal GA"), "function" == typeof __ga && __ga("strk.send", "pageview"), 
            this.isGoogleAnalyticsEnabled() ? this.isUniversalAnalytics() ? ($B.log("[GA] Send page view to user GA (Universal)"), 
            "function" == typeof ga ? ga("send", "pageview") : void 0) : ($B.log("[GA] Send page view to user GA (Classic)"), 
            _gaq.push([ "_trackPageview" ])) : void 0;
            ...
            return t = _.extend({
                eventName: "PageView"
            }, this.baseData), this.trackPageViewOnGA(), this.trackPageEventOnGA("Page", t.eventName, null, null, this.baseData), 
    ...
    window.partial = function(e, t) {
        ...
        return e.prototype.transform = function() {
            ...
            u = g.length; u > r; r++) n = g[r], t = $(n), $("<div id='" + t.attr("id") + "_temp' style='display:none;'>" + t.html() + "</div>").appendTo(this.domTree);
            for (this.indexGenerator = new $B.IndexGenerator(), i = [ this.textTransformer, this.imageTransformer, this.htmlTransformer ], 
            s = 0, c = i.length; c > s; s++) o = i[s], o.indexGenerator = this.indexGenerator;
            for (a = 0, d = i.length; d > a; a++) o = i[a], o.transform(this.domTree, this.isEdit);
            for (p = this.domTree.find("[data-component='repeatable_item_template']"), m = [], 
            l = 0, h = p.length; h > l; l++) n = p[l], t = $(n), e = $("#" + t.attr("id") + "_temp"), 
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.TH = $B.TH || {}, $B.TH.Core = {
        ...
        enableSlider: function(e) {
            ...
            return i = $.extend({
                ...
                }, 100))), (null != (s = $.browser) ? s.chrome : void 0) ? i.find(".video-bg-wrap iframe").css("top", "+=1").css("top", "-=1") : void 0) : !1;
            }, d = function(e) {
                var o, i;
        ...
        setupStrikinglyLogo: function(e) {
            return function(e) {
                ...
                $B.TH.pbsVariationId = 1, -1 !== e || n.length && n.is(":visible") ? ($(".logo-footer, .logo-footer-var2, .logo-footer-var3").hide(), 
                ...
                i = -90, n.css({
                    ...
                    i > r && (r = i), n.css({
                        bottom: r
                    }).show(), -10 > r && t.scrollTop() === t.height() - o.height() ? n.show().animate({
                        bottom: -10
                    }) : void 0) : n.css({
                        bottom: i
                    });
        ...
        setupVideoBackground: function() {
            ...
            t = [], o = [], n = function() {
                return $B.TH.Core.youtubeBgVideoList.length = 0, t.length = 0, o.length = 0, $(".video-bg-wrap").each(function() {
                    var e, n, i, r, s, a;
                    return n = $(this), n.closest("#s-header-bg-editor").length || (s = ($(this).attr("data-video-html") || "").replace("&origin=", "&origin=" + $.url().attr("base")).replace(/(https?):/, ""), 
                    n.html(s), "" === s) ? void 0 : (e = n.find("iframe"), (-1 !== s.indexOf("youtube.com") ? $B.TH.Core.youtubeBgVideoList : o).push(e), 
                ...
                o.length ? (i = {
                    ...
                    i.event) {
                      case "ready":
                        ...
                        n($("#" + i.player_id), e);
                        for (h = [], r = l = 0, c = o.length; c > l; r = ++l) a = o[r], e = !($B.getCustomization("enableSoundForVideoBg") && 0 === r), 
                        h.push(n(a, e));
                        return h;

                      case "pause":
                        if (null != i.player_id) return s($("#" + i.player_id));
                        for (g = [], u = 0, d = o.length; d > u; u++) a = o[u], g.push(s(a));
                        return g;
                    }
                })) : void 0;
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.TH = $B.TH || {}, $B.TH.Decorator = {
        ...
        matchHeightsAll: function(e) {
            ...
            return e.length <= 1 ? void e.each(function() {
                ...
                return e.each(function() {
                    ...
                    var e, n;
                    return n = $(this), n.css("min-height", t), e = n.find("img"), "" === $.trim(n.find(".s-component-content").text()) && e.length ? (e.css("vertical-align", "middle"), 
        ...
        applyMatchHeights: function(e, t) {
            var n, o, i, r, s;
            return null == e && (e = ".s-mhi"), null == t && (t = ".s-mh"), o = function(n) {
                ...
                return o(!1), i();
            }), o(!0), window.edit_page.isShowPage ? void 0 : (r = function(t, n, i) {
                var r, s;
        ...
        applyRowVerticalAlign: function(e, t, n) {
            var o, i, r, s;
            return null == e && (e = ".s-rva-text"), null == t && (t = ".s-rva-media"), null == n && (n = ".s-rva"), 
            o = function(n) {
                var o, i, r, s, a;
                ...
                return i(), r();
            }), window.edit_page.isShowPage ? void 0 : (window.edit_page.Event.subscribe("Section.componentSaved", i), 
            window.edit_page.Event.subscribe("Slide.afterAdd", i));
        },
        fitText: function(e) {
            return 0 !== e.length ? e.each(function(e, t) {
                var n, o, i, r, s;
                return s = $(this), r = s.width(), i = parseInt(s.css("font-size")), n = s.css({
                    position: "absolute"
                }).width(), s.css({
                    position: "relative"
                }), r >= n ? void 0 : (o = i * r / n, s.css({
                    "font-size": o
                }));
            }) : void 0;
        },
        ...
        applyTableFormatting: function() {
            ...
            return t = function(e, t) {
                var n, o, i, r, s;
                for (n = e.split("|||"), i = $("<tr>"), r = 0, s = n.length; s > r; r++) o = n[r], 
                $("<td>").append(o).appendTo(i);
                return t.append(i);
            }, e = window.edit_page.v4 ? $(".s-component.s-text .s-component-content") : $(".text-component .content"), 
            e.each(function() {
                var e, n;
                return e = $(this), -1 !== e.text().indexOf("|||") ? (n = $('<table class="s-text-table">'), 
                e.children("div, p").each(function() {
                    return t($(this).html(), n);
                }), e.html("").append(n)) : void 0;
            });
        },
        fancyBoxVideoSetup: function(e) {
            return function() {
                ...
                }, e = window.edit_page.v4 ? $(".s-component.s-text .s-component-content a, .s-component.s-image .s-component-content a, .s-component.s-media .s-component-content a") : $(".text-component a, a.image-link, .image-content a"), 
                e.each(function() {
                    var e;
                    return e = $(this).attr("href"), t(e) ? $(this).fancybox({
                        padding: 0,
                        closeBtn: !1,
                        helpers: {
                            media: {}
        ...
        containBackgroundImages: function(e) {
            return function(e) {
                var t, n, o;
                return null == e && (e = (null != (o = window.edit_page) ? o.v4 : void 0) ? $(".s-section").not(".s-blog-section,.s-store-section,.s-social-feed-section") : $(".wide, .wide-bg, .wide-container, .widecontainer")), 
                e = e.filter(function() {
                    var e;
                    return e = $(this).css("background-image"), "" === $.trim($(this).text()) && _.all($(this).find("img"), function(e) {
                        var t;
                        return t = $(e).attr("src") || $(e).attr("data-original"), null == t || -1 !== ("function" == typeof t.indexOf ? t.indexOf("transparent.png") : void 0);
                    }) && 0 === $(this).find("iframe").length && "none" !== e && -1 === e.indexOf("transparent.png") && !$(this).hasClass("no-contain");
                    ...
                    return $B.TH.Util.getBackgroundImageSize(e, function(t) {
                        ...
                        e.find("*").removeAttr("data-reactid"), n = $(".navbar-drawer-bar"), n.is(":visible") && 0 === e.offset().top ? e.css("margin-top", n.height()) : void 0;
                    });
                }, t = function() {
        ...
        trackFileDownload: function() {
            return window.edit_page.v4 ? void 0 : $(".text-component a, .button-component a, a.button-component").each(function() {
                var e, t, n;
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.TH = $B.TH || {}, $B.TH.Fixer = {
        ...
        resizeIFrames: function(e) {
            ...
            return n = function(e) {
                ...
                return l = parseInt(t.css("margin-top"), 10) || 0, o = parseInt(t.css("margin-bottom"), 10) || 0, 
                s = t.parent().height(), i = n(t) + l + o, a = Math.max(s, i), 50 >= a ? void 0 : (e.height(a), 
        ...
        preventAppScrolling: function(e) {
            ...
            return t = $(e), t.each(function() {
                ...
                return e = $(this), $B.TH.Util.isMobile() ? (e.css("pointer-events", "none"), e.parent().click(function() {
                    ...
                    return Math.abs(o.screenX - t) >= 10 || Math.abs(o.screenY - n) >= 10 ? e.css("pointer-events", "auto") : void 0;
            ...
            if (e || (e = $B.TH.Fixer.detectLanguage()), !window.edit_page.v4) {
                ...
                i[e]) {
                    r = i[e].toSlug(), s = {}, n.each(function() {
                        ...
                        s[t]) ? void 0 : (a = o.replace(/,\s*serif|,\s*sans-serif/gi, ""), s[t] = a + ", " + i[e] + " !important");
                    }), c = [];
        ...
        fixNbsp: function(e) {
            ...
            e.find("div, p").each(function() {
                ...
                if (-1 !== $(this).text().indexOf(" ")) {
                    for (s = [], t = function(e) {
                        var n, o, i, r, a;
                        for (r = e.childNodes, a = [], o = 0, i = r.length; i > o; o++) n = r[o], 3 === n.nodeType ? a.push(s.push(n)) : a.push(t(n));
                        return a;
                    }, t(this), d = [], a = 0, l = s.length; l > a; a++) r = s[a], n = r.nodeValue.match(/^\s+$/), 
                    o = "DIV" === (u = r.parentNode.tagName) || "P" === u, i = ("SPAN" === (c = r.parentNode.tagName) || "STRONG" === c || "EM" === c) && $(this).text() === r.nodeValue, 
                    n && (o || i) ? (e = $(r.parentNode), 0 === e.children().length && -1 !== e.css("font-family").toLowerCase().indexOf("brandon") ? d.push(e.css("opacity", 0)) : d.push(void 0)) : d.push(r.nodeValue && (r.nodeValue = r.nodeValue.replace(/\u00a0/g, " ")));
                    return d;
                }
            });
        },
    ...
    $B.Event = function() {
        ...
        return e.prototype.subscribe = function(e, t) {
            ...
            for (i = this.topics[e].slice(), a = [], r = 0, s = i.length; s > r; r++) {
                o = i[r];
                try {
                    a.push("function" == typeof o.func ? o.func(e, t) : void 0);
                } catch (l) {
                    n = l, a.push(console.warn("Cannot trigger subscription! " + n));
                }
            }
            return a;
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.Navigator = function() {
        ...
        return t.prototype.init = function() {
            ...
            for (o = [], a = window.edit_page.isShowPage ? $S.page_meta.slide_names : function() {
                var e, t, n, o;
                for (n = window.edit_page.data.slides(), o = [], e = 0, t = n.length; t > e; e++) s = n[e], 
                o.push(s.components.slideSettings.name());
                return o;
            }(), t = l = 0, u = a.length; u > l; t = ++l) {
                for (r = a[t], n = i = "#" + this.getSlug(r, t), e = 1; -1 !== $.inArray(n, o); ) n = i + "-" + e++;
                o.push(n);
            }
            return o;
    ...
    window.currentComponent = null, window.currentRepeatable = null, $B.EditorTracker = function(t) {
        ...
        return n(o, t), o.include($B.ComponentHelper), o.prototype.isState = function(e) {
            ...
            n = !1, s = this.subscribers, i = 0, r = s.length; r > i; i++) o = s[i], o.event.toString() === e.toString() && (n = !0, 
            o.listeners.push(t));
            ...
            var n, o, i, r, s, a, l, u;
            if (this.subscribers) for (l = this.subscribers, i = 0, s = l.length; s > i; i++) if (o = l[i], 
            o.event.test(e)) for (u = o.listeners, r = 0, a = u.length; a > r; r++) n = u[r], 
            n.call(this, t);
    ...
    window.asset_path = function(e) {
        ...
        function n(t) {
            ...
            this.isNull(t.showMobileNav) && (t.showMobileNav = !0), o = function(e) {
                return function(t, n) {
                    var o, i, r, s;
                    for (null == n && (n = []), s = [], i = 0, r = n.length; r > i; i++) o = n[i], e.isNull(t[o]) ? s.push(void 0) : s.push(t[o] = t[o].toLowerCase());
                    return s;
                };
        ...
        return o(n, t), n.prototype.selectedPreset = function() {}, n.prototype.fontStyle = function(e) {
            ...
            if (this.slides.subscribe(function(e) {
                return function(e) {
                    ...
                    for (i = 0, s = e.length; s > i; i++) n = e[i], n.html().find(".section-anchor").attr("data-scroll-name", "#" + (n.index() + 1)), 
                ...
                for (h = this.slides(), p = [], s = 0, u = h.length; u > s; s++) o = h[s], p.push(o.bind());
                return p;
            }
            for (g = this.slides(), t = a = 0, c = g.length; c > a; t = ++a) o = g[t], 2 > t ? i(o, t) : n.push({
                slide: o,
                index: t
            });
        ...
        return o(n, t), n.StripHtml = function(e) {
            ...
            var t;
            return this.html().append($('<div class="s-delete-slide-shade"></div>')), t = -1 !== this.template_name().indexOf("blog") ? I18n.t("js.pages.edit.confirm.delete_blog_section") : I18n.t("js.pages.edit.confirm.delete_section"), 
        ...
        return o(n, t), n.prototype.render = function() {
            ...
            if ("function" == typeof $B.isHeadlessRendering ? !$B.isHeadlessRendering() : !0) {
                for (n = "", a = this.button_list(), o = 0, r = a.length; r > o; o++) t = a[o], 
                t.show_button() && (n += t.getTemplate());
                for (this.mediaListHtml(n), console.log("Rendering social media"), l = this.button_list(), 
                u = [], i = 0, s = l.length; s > i; i++) t = l[i], e = $('meta[name="force-social-js"]') && "true" === $('meta[name="force-social-js"]').attr("content"), 
        ...
        return o(n, t), n.prototype.remove = function(e) {
            ...
            var e, t, n, o, i, r, s;
            for (r = this.parent.list(), s = [], o = 0, i = r.length; i > o; o++) t = r[o], 
            s.push(function() {
                var o, i;
                o = t.components, i = [];
        ...
        function n(t, o) {
            ...
            this.selectedIdx = ko.observable(0), this.formOpen = ko.observable(!1), l = function(e, t) {
                ...
                return o;
            }(), c = 0, d = s.length; d > c; c++) a = s[c], u(a[0], a[1]);
            ...
            this.storeStyle(e), t = {
                ...
                handlers: {
                    imageSelected: function(e) {
                        return function(t) {
                            var n, o, i, r, s;
                            for (o = e._imageStyle, s = [], i = 0, r = t.length; r > i; i++) n = t[i], s.push(e.add({
        ...
        function n(t, o, i, r) {
            ...
            n.__super__.constructor.call(this, this.root, o, i), s = o.description ? o.description.length > 0 : !1, 
        ...
        return o(n, t), n.prototype.getSelectedClassName = function() {
            ...
            var t, n, o, i, r, s, a, l, u;
            if ("solidBanner" === e) {
                for (s = [ "banners/banner1", "bg3", "banners/banner3" ], l = [], n = 0, i = s.length; i > n; n++) t = s[n], 
                l.push(this.bgObject(t));
                return l;
            }
            for (a = [ "bg1", "bg5", "bg6" ], u = [], o = 0, r = a.length; r > o; o++) t = a[o], 
            ...
            return window.edit_page.isShowPage ? (this.reset(), this.isLoading(!0), e.closest("form").ajaxSubmit({
                ...
                error: function(e) {
                    return function(t, n, o) {
                        ...
                        return i.message.invalid_email && e.invalidEmail(!0), i.message.invalid_name && e.invalidName(!0), 
                        i.message.invalid_phone_number ? e.invalidPhoneNumber(!0) : void 0;
                    };
                }(this)
            })) : void 0;
    ...
    $B.RichText = function(t) {
        ...
        o.TINYMCE_OPTIONS.valid_elements = $.map($S.conf.TEXT_EDITOR_ELEMENTS_CONFIG, function(e) {
            ...
            return t = [ 60, 80, 100, 130, 160 ], o = 14, n = 84, s = function(e) {
                ...
                var r, a, l;
                return a = s(e), a.px >= n && i > 0 ? !1 : a.px <= o && 0 > i ? !1 : (l = $.inArray(a.perc, t), 
    ...
    $B.BlogCollectionComponent = function(t) {
        ...
        return n(o, t), o.prototype.setupNavButtons = function(e) {
            ...
            e === this.page ? r.hide() : r.show().click(function(e) {
                ...
                }(this), t = l = 1; i >= 1 ? i >= l : l >= i; t = i >= 1 ? ++l : --l) a(t);
    ...
    $B.EcommerceComponent = function(t) {
        ...
        i.prototype._productsData = [], i.prototype._settings = {
            currencyCode: "USD",
            currencySymbol: "$",
            feePerOrder: 10,
            feePerAdditionalItem: 1
        }, i.prototype._accounts = {
            stripe: "",
            paypal: ""
        }, i.prototype._loadSettings = function() {
            var e, t, n;
            return t = $B.getMeta("page_meta.id"), e = "/r/v1/sites/" + t + "/ecommerce", n = function() {
                return this._settings = data.data, this._settings.currencySymbol = this._settings.currencyData.symbol, 
                this._getPriceScope(this._products), this._renderProducts();
            }, $.ajax({
                type: "GET",
                url: e,
                beforeSend: function(e) {
        ...
        }, i.prototype._loadAccounts = function() {}, i.prototype._getPriceScope = function(e) {
            var t, n, i, r, s, a, l, u, c, d, h;
            for (h = [], u = 0, c = e.length; c > u; u++) a = e[u], r = "(" + this._settings.currencyCode + ") " + this._settings.currencySymbol, 
            a.currencyCode = this._settings.currencyCode, a.currencyType = this._settings.currencySymbol, 
            s = function() {
                var e, t, n, o;
                for (n = a.variations, o = [], e = 0, t = n.length; t > e; e++) l = n[e], o.push(parseFloat(l.price) || 0);
                return o;
            }(), d = a.currencyCode, t = o.call(this.ZERO_DECIMAL_CURRENCY_LIST, d) >= 0 ? 0 : 2, 
            i = Math.min.apply(null, s).toFixed(t), n = Math.max.apply(null, s).toFixed(t), 
            i === n ? h.push(a.priceScope = r + i) : h.push(a.priceScope = r + i + " - " + a.currencyType + n);
            return h;
        }, i.prototype._checkQuantity = function(e) {
            var t, n, o, i, r, s, a, l, u;
            for (u = [], i = 0, s = e.length; s > i; i++) {
                for (n = e[i], t = !0, l = n.variations, r = 0, a = l.length; a > r; r++) o = l[r], 
            ...
            return r;
        }, i.prototype._renderProducts = function() {
            var e, t, n, o, i, r;
            return $(".ecommerce.editable .edit-overlay .edit-button").length && (e = this._productsData.length ? I18n.t("js.pages.ecommerce.text.edit_btn_mange_product") : I18n.t("js.pages.ecommerce.text.edit_btn_add_product"), 
            $(".ecommerce.editable .edit-overlay .edit-button").html(e)), $("#ecommerce-products-wrapper").html(_.template($("#ecommerce-product-tmpl").html(), {
                products: this._productsData
            })), r = window.edit_page.Event.subscribe("EcommerceBuy.Loaded", function(e) {
                return function() {
                    return e.isDialogLoaded = !0;
                };
            }(this)), n = this.openBuyDialog, t = function(e) {
                return function() {
                    return e.isDialogLoaded;
                };
            }(this), o = this._productsData, i = this._settings, $("#ecommerce-products-wrapper").find(".product-card").each(function() {
                return $(this).find(".order-btn .green").length ? $(this).find(".order-btn").click(function() {
                    var e;
                    return e = $(this).data("product-id"), n(), $B.waitFor(t, function() {
                        return window.edit_page.Event.publish("EcommerceBuy.OpenDialogWithProductData", {
                            product: _.find(o, function(t) {
                                return +t.id === +e;
                            }),
                            settings: i
            ...
            e = "/r/v1/sites/" + t + "/products", n = function(e) {
                return function(t) {
                    return e._converProductPrice(t.data.products), e._getPriceScope(t.data.products), 
                    e._checkQuantity(t.data.products), e._productsData = t.data.products, e._renderProducts();
                };
            }(this), $.ajax({
                type: "GET",
                url: e,
    ...
    ko.bindingHandlers.stopBinding = {
        ...
        update: function(e, t) {
            ...
            i = a + n.height(), s = o.scrollTop(), r = o.height(), s > a || i > r ? o.scrollTo(n) : void 0;
        }
        ...
        init: function(e, t, n, o, i) {
            ...
            return r = function() {
                ...
                return n = t(), n.options || (n.options = {}), ko.utils.extend(n.options, {
                    ...
                    start: function(e, n) {
                        var o, i, r, s;
                        for (o = ko.utils.unwrapObservable(t()).data(), r = 0, s = o.length; s > r; r++) i = o[r], 
                        i.renameDone();
                        return !0;
                    },
        ...
        init: function(e, t, n, o, i) {
            ...
            return r = function() {
                ...
                return n = t(), n.options || (n.options = {}), ko.utils.extend(n.options, {
                    ...
                    afterMove: function(t) {
                        var n, o, i, r, s;
                        for (o = t.targetParent(), r = 0, s = o.length; s > r; r++) i = o[r], i.afterMovedHandler();
    ...
    window.$B = window.Bobcat = window.$B || {}, $B.SocialMediaConfig = function() {
        ...
        return t.prototype.get = function(e) {
            ...
            for (n = this.getDefaultButtonListData(), t.button_list ? r = function() {
                ...
                return r;
            }() : (t.button_list = [], r = []), u = [], s = 0, a = n.length; a > s; s++) i = n[s], 
